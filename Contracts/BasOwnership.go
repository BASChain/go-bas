...
// Allowence is a free data retrieval call binding the contract method 0xa021b247.
//
// Solidity: function allowence(address owner, bytes32 nameHash) constant returns(address)
func (_BasOwnership *BasOwnershipCaller) Allowence(opts *bind.CallOpts, owner common.Address, nameHash [32]byte) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _BasOwnership.contract.Call(opts, out, "allowence", owner, nameHash)
	return *ret0, err
}
...
//
// Solidity: function allowence(address owner, bytes32 nameHash) constant returns(address)
func (_BasOwnership *BasOwnershipSession) Allowence(owner common.Address, nameHash [32]byte) (common.Address, error) {
	return _BasOwnership.Contract.Allowence(&_BasOwnership.CallOpts, owner, nameHash)
}

// Allowence is a free data retrieval call binding the contract method 0xa021b247.
//
// Solidity: function allowence(address owner, bytes32 nameHash) constant returns(address)
func (_BasOwnership *BasOwnershipCallerSession) Allowence(owner common.Address, nameHash [32]byte) (common.Address, error) {
	return _BasOwnership.Contract.Allowence(&_BasOwnership.CallOpts, owner, nameHash)
}
