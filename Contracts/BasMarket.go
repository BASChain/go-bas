...
//
// Solidity: function SellOrders(address , bytes32 ) constant returns(uint256 price, uint256 updateTime)
func (_BasMarket *BasMarketCaller) SellOrders(opts *bind.CallOpts, arg0 common.Address, arg1 [32]byte) (struct {
	Price      *big.Int
	UpdateTime *big.Int
}, error) {
	ret := new(struct {
...
//
// Solidity: function SellOrders(address , bytes32 ) constant returns(uint256 price, uint256 updateTime)
func (_BasMarket *BasMarketSession) SellOrders(arg0 common.Address, arg1 [32]byte) (struct {
	Price      *big.Int
	UpdateTime *big.Int
}, error) {
...
//
// Solidity: function SellOrders(address , bytes32 ) constant returns(uint256 price, uint256 updateTime)
func (_BasMarket *BasMarketCallerSession) SellOrders(arg0 common.Address, arg1 [32]byte) (struct {
	Price      *big.Int
	UpdateTime *big.Int
}, error) {
	return _BasMarket.Contract.SellOrders(&_BasMarket.CallOpts, arg0, arg1)
...
// FilterAskAdded is a free log retrieval operation binding the contract event 0x673324eec3f18411c363cf2f01674b2745a84ae33967a2037f84c95e93dec3ce.
//
// Solidity: event AskAdded(bytes32 nameHash, address operator, uint256 price)
...
// WatchAskAdded is a free log subscription operation binding the contract event 0x673324eec3f18411c363cf2f01674b2745a84ae33967a2037f84c95e93dec3ce.
//
// Solidity: event AskAdded(bytes32 nameHash, address operator, uint256 price)
...
// ParseAskAdded is a log parse operation binding the contract event 0x673324eec3f18411c363cf2f01674b2745a84ae33967a2037f84c95e93dec3ce.
//
// Solidity: event AskAdded(bytes32 nameHash, address operator, uint256 price)
...
// FilterAskChanged is a free log retrieval operation binding the contract event 0x23c5bd037443f93fc00da0e8e36deec28d7708ba624438f8ba53cf0aa8146f4b.
//
// Solidity: event AskChanged(bytes32 nameHash, address operator)
...
// WatchAskChanged is a free log subscription operation binding the contract event 0x23c5bd037443f93fc00da0e8e36deec28d7708ba624438f8ba53cf0aa8146f4b.
//
// Solidity: event AskChanged(bytes32 nameHash, address operator)
...
// ParseAskChanged is a log parse operation binding the contract event 0x23c5bd037443f93fc00da0e8e36deec28d7708ba624438f8ba53cf0aa8146f4b.
//
// Solidity: event AskChanged(bytes32 nameHash, address operator)
...
// FilterSellChanged is a free log retrieval operation binding the contract event 0xc28bb16c521f01de9727f607484f5a84a3919ff2380b3c2293e263567ee2aeeb.
//
// Solidity: event SellChanged(bytes32 nameHash, address operator)
...
// WatchSellChanged is a free log subscription operation binding the contract event 0xc28bb16c521f01de9727f607484f5a84a3919ff2380b3c2293e263567ee2aeeb.
//
// Solidity: event SellChanged(bytes32 nameHash, address operator)
...
// ParseSellChanged is a log parse operation binding the contract event 0xc28bb16c521f01de9727f607484f5a84a3919ff2380b3c2293e263567ee2aeeb.
//
// Solidity: event SellChanged(bytes32 nameHash, address operator)
